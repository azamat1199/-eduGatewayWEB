...
import logo_education from "../../icon/Logo_education.svg"
                ...
                <div className="block">
                    <div className="blockBox">
                        ...
                        <div className="loginInput">
                            <p>Введите номер телефона или email адрес указанные при рег-ции</p>
                            <div>
                                <input type="text" />
                            </div>
                        </div>
                            ...
                            <p>Вспомнили пароль? <Link to="/login"> Войти</Link></p>
									...
									<Fade in={open}>
										<div className="loginStafModal">
											...
											<p>На ваш email мы отправили ссылку для восстановления пароля</p>
											<div>
													<button>Отправить еще раз</button>
													<button onClick={handleClose}>Вернуться</button>
											</div>
											<img src={close_modal} onClick={handleClose} alt="" className="close_modal"/>
										</div>
									</Fade>
									</Modal>
                    </div>
